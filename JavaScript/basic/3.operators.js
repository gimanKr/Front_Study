...
/**
 * 논리연산자
 * &&(and) : 양쪽 조건이 모두 true일때 true를 반환
 * ||(or) : 양쪽 조건중 하나라도 true일때 true를 반환
 */
 ...
 */
console.log(true && 'giman');
console.log(false && 'giman');
console.log(true || 'giman');
console.log(false || 'giman');
